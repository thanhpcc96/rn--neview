...
let TouchableComponent: any = null;
...
export default class PlatformTouchable extends React.Component<any> {
  ...
  render() {
    let { children, style, foreground, background, useForeground, ...props } =
      this.props;
